...
class DeliveryConfirmedBottomSheet extends StatefulWidget {
  const DeliveryConfirmedBottomSheet({super.key});

  @override
  State<DeliveryConfirmedBottomSheet> createState() =>
      _DeliveryConfirmedBottomSheetState();
}

class _DeliveryConfirmedBottomSheetState
    extends State<DeliveryConfirmedBottomSheet> {
  @override
