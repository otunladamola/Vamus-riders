...
class FleetNotifications extends StatefulWidget {
  const FleetNotifications({super.key});

  @override
  State<FleetNotifications> createState() => _FleetNotificationsState();
}

class _FleetNotificationsState extends State<FleetNotifications> {
  @override
      ...
      body: ListView(
        children: [
          ...
          deliveryDetails(
              ...
              senderFirstLetter: "D"),
          deliveryDetails(
              notText: "You’ve just added a ride to your fleet",
              timeStamp: "7th March, 2022",
              senderFirstLetter: "R")
        ],
      ),
